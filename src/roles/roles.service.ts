...
export class RolesService {
  ...
  async create(createRoleDto: CreateRoleDto) {
    createRoleDto.name = captalizeFirstLetterOfEachWordInPhrase(createRoleDto.name);
  ...
  async update(id: number, updateRoleDto: UpdateRoleDto) {
    ...
    updateRoleDto.name = captalizeFirstLetterOfEachWordInPhrase(updateRoleDto.name);
